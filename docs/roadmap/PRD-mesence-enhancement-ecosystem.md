...
3b. **Phase 9 F9.22 (states pending) after F9.23**, F9.20 shipped
   ...
   2026-09-13 (§3). What stays open in F9.22 is coverage: Contra stages
   3–8 with the headless chain tooling, and probe scripts for any later
   state whose cycles should carry a `driver`.
